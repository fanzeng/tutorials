...
static GstFlowReturn new_sample(GstElement *sink, CustomData *data) {
    ...
    g_printerr("in new_sample, get NULL for sample");
...
int main(int argc, char* argv[]) {
    ...
    data.audio_convert1 = gst_element_factory_make("audioconvert", "audioconvert1");
    ...
    data.video_sink = gst_element_factory_make("xvimagesink", "videosink");
    ...
    if (gst_element_link_many(data.app_source, data.tee, NULL) != TRUE ||
        gst_element_link_many(data.audio_queue,
                                data.audio_convert1,
                                data.audio_resample,
                                data.audio_sink,
                                NULL) != TRUE ||
        gst_element_link_many(data.video_queue,
                                data.audio_convert2,
                                data.visual,
                                data.video_convert,
                                data.video_sink,
